...
mod enhanced_tests {
    use super::*;
    use crate::component::{ComponentId, LifecyclePhase, UpdateScheduler, ComponentBase, AnyComponent};
    ...
    fn test_component_base() {
        ...
        assert_eq!(base.lifecycle_phase(), LifecyclePhase::Created);
        
        base.set_lifecycle_phase(LifecyclePhase::Mounted);
        assert_eq!(base.lifecycle_phase(), LifecyclePhase::Mounted);
    }
    ...
    impl crate::component::Props for TestNewProps {}
    ...
    impl AnyComponent for TestNewComponent {
        fn component_id(&self) -> ComponentId {
        ...
        fn set_lifecycle_phase(&mut self, phase: LifecyclePhase) {
            self.base.set_lifecycle_phase(phase);
        }
    ...
    fn test_enhanced_component_creation() {
        ...
        assert_eq!(component.lifecycle_phase(), LifecyclePhase::Created);
    }
    ...
    fn test_any_component_trait() {
        ...
        // Test type name
        assert_eq!(component.type_name(), std::any::type_name::<TestNewComponent>());
        
        // Test that we can use it as AnyComponent
        let any_component: &dyn AnyComponent = &component;
        assert_eq!(any_component.component_id(), component.component_id());
        assert_eq!(any_component.lifecycle_phase(), LifecyclePhase::Created);
    }
    ...
    fn test_component_base_with_layout() {
        ...
        assert_eq!(base.layout_style().width, crate::layout::Dimension::Points(100.0));
        assert_eq!(base.layout_style().height, crate::layout::Dimension::Points(200.0));
        assert_eq!(base.layout_style().flex_direction, crate::layout::FlexDirection::Column);
    }
    ...
    fn test_component_layout_node_creation() {
        ...
        assert_eq!(layout_node.style.width, crate::layout::Dimension::Points(150.0));
        assert_eq!(layout_node.style.height, crate::layout::Dimension::Points(100.0));
    ...
    fn test_component_layout_style_modification() {
        ...
        assert_eq!(base.layout_style().width, crate::layout::Dimension::Points(200.0));
        ...
        assert_eq!(base.layout_style().height, crate::layout::Dimension::Percent(50.0));
        assert_eq!(base.layout_style().flex_direction, crate::layout::FlexDirection::Row);
    }
