...
echo "=================================================="
echo 
echo "The following steps will help you reconfigure GitHub Pages after renaming the repository from 'orbitrs' to 'orbitui'"
echo
...
if ! command -v gh &> /dev/null; then
    ...
    echo "And then: gh repo view orbitrs/orbitui --web"
    echo
fi
...
echo "   https://github.com/orbitrs/orbitui/settings/pages"
echo
...
echo "   https://github.com/orbitrs/orbitui/actions/workflows/pages.yml"
echo "   Click 'Run workflow' button"
echo
echo "4. Wait for the workflow to complete and then check:"
echo "   https://orbitrs.github.io/orbitui/"
echo
...
if [[ "$trigger_workflow" == "y" ]]; then
    if command -v gh &> /dev/null; then
        ...
        gh workflow run pages.yml --repo orbitrs/orbitui
        echo "Workflow triggered! Check status at: https://github.com/orbitrs/orbitui/actions"
    else
